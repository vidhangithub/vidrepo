...
<div align="right"><a href="submitterLogout.infy">Logout</a></div>	

    
<fieldset>
<legend>Submitter Dash Board</legend>
...
<tbody>
<c:forEach var="sDashborad" items="${SDashBoard}" varStatus="matCounter">
<tr>
<td> <c:out value="${sDashborad.application_id}"></c:out> </td>
<td> <c:out value="${sDashborad.query}"></c:out> </td>
<td> <c:out value="${sDashborad.db_details}"></c:out> </td>
<td> <c:out value="${sDashborad.query_submitted_date}"></c:out> </td>
<td> <c:out value="${sDashborad.approved_reject_date}"></c:out> </td>
<td> <c:out value="${sDashborad.approved_by}"></c:out> </td>
<td> <c:out value="${sDashborad.rejection_reason}"></c:out> </td>
<td> <c:out value="${sDashborad.coments}"></c:out> </td>
</tr>
</c:forEach>
</tbody>
<tfoot>
