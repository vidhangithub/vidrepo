...
<%@ page errorPage="error.jsp" import="java.util.Set,java.util.Iterator,java.util.Map,com.infosys.aetnams.chat.*"%>
<%
	...
	{
		response.sendRedirect("/WEB-INF/views/chatSystem/listrooms.jsp");
	}
	else
	{
		...
		if (chatRoomOld != null && chatRoom != null)
		{
			...
			response.sendRedirect("/WEB-INF/views/chatSystem/chat.jsp");
		}
		else
		{
